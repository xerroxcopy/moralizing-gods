...
Not sure why matrix is used for `Vars`. Trying tibble
```{r}
...
dat <- 
  ...
  mutate(Variable = paste(Subsection, Variable)) # str_c does not work: "a" + NA = NA
```
...
# dat2 <- dat[dat$Section==Section1 | dat$Section==Section2 | dat$Section==Section3,] 
