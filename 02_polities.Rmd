...
I started to think that I don't need to "construct" all these in regular timesteps... Just `spread()` the `df_min` and map2?
...
df_spread<- 
  df_join %>% spread(key = Variable, value = Value) 
